...
let sel = t("<select>").attr({
            ...
            r.append(n).append(o).append(c).append(ow).append(del), a.agreement.isChecked && r.append(d), k.append(u).append(m), s.append(r).append(k), m.click(function(t) {
                t.preventDefault();
                let s = e.getProducts() || {};
