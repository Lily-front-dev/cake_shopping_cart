document.addEventListener("DOMContentLoaded", function() {
    ...
    t = jQuery, a = {
        ...
        showProducts: function(s) {
            ...
            e.closeModalBasket(ui);
                n = t("<div>").attr({
                    class: "smart-basket__product-item",
                    id: "product-item-header"
                }),
                i = t("<div>").attr({
                ...
                }).text("Оставьте свои контактные данные и мы перезвоним вам для подтверждения заказа в течение 10 минут"),
                l = t("<div>").attr({
            ...
            n.append(o).append(i).append(u).append(l).append(m).append(k), r.append(ui).append(n);
            for (let n in s) {
                let i = t("<div>").attr({
                        class: "smart-basket__product-item"
                    }),
        ...
        stateBasket: function() {
            ...
            return e.getSmartBasketMinState(o), c.click(function() {
                ...
                if (void 0 !== r[n]) {
                    let a = t(this).html();
                    return t(this).text("+"), t("body").append(e.alertBlock("alreadyAdded")), setTimeout(() => {
                        t(this).html(a)
                    }, 1500), !1
                } {
                    let i = {};
...
let pay = t("<select>").attr({
                    ...
                    opt22 = t("<option>").attr({
                        value: "Оплата при доставке (наложенный платеж)"
                        }).text("Оплата при доставке (наложенный платеж)");
                    opt23 = t("<option>").attr({
                        value: "Оплата на банковскую карту"
                        }).text("Оплата на банковскую карту");  
                    pay.append(opt21).append(opt22).append(opt23);
                    lab.append(pay);
                    n.append(lab);
...
let sel = t("<select>").attr({
                    ...
                    opt2 = t("<option>").attr({
                        value: "Новая Почта на отделение"
                        }).text("Новая Почта на отделение");
                    opt3 = t("<option>").attr({
                        value: "Новая Почта курьером"
                        }).text("Новая Почта курьером");
                    sel.append(opt1).append(opt2).append(opt3);
                    lab.append(sel);
                    ow.append(lab);


let region = t("<div>").attr({
                    class: "smart-basket__input-wrapper"
                });
...
let reg = t("<select>").attr({
                    ...
                    opt32 = t("<option>").attr({
                        ...
                        }).text("Винницкая область");
                    opt33 = t("<option>").attr({
                        value: "Волынская область"
                        }).text("Волынская область");
                    opt34 = t("<option>").attr({
                        value: "Днепропетровская область"
                        }).text("Днепропетровская область");
                    opt35 = t("<option>").attr({
                    ...
                    opt37 = t("<option>").attr({
                        ...
                        }).text("Закарпатская область");
                    opt38 = t("<option>").attr({
                        value: "Запорожская область"
                        }).text("Запорожская область");
                    opt39 = t("<option>").attr({
                        value: "Ивано-Франковская область"
                        }).text("Ивано-Франковская область");
                    opt310 = t("<option>").attr({
                        value: "Киевская область"
                        }).text("Киевская область");
                    opt311 = t("<option>").attr({
                        value: "Кировоградская область"
                        }).text("Кировоградская область");
                    opt312 = t("<option>").attr({
                        value: "Луганская область"
                        }).text("Луганская область");
                    opt313 = t("<option>").attr({
                        value: "Львовская область"
                        }).text("Львовская область");
                    opt314 = t("<option>").attr({
                        value: "Николаевская область"
                        }).text("Николаевская область");
                    opt315 = t("<option>").attr({
                        value: "Одесская область"
                        }).text("Одесская область");
                    opt316 = t("<option>").attr({
                        value: "Полтавская область"
                        }).text("Полтавская область");
                    opt317 = t("<option>").attr({
                        value: "Ровненская область"
                        }).text("Ровненская область");
                    opt318 = t("<option>").attr({
                        value: "Сумская область"
                        }).text("Сумская область");
                     opt319 = t("<option>").attr({
                        value: "Тернопольская область"
                        }).text("Тернопольская область");
                    opt320 = t("<option>").attr({
                        value: "Харьковская область"
                        }).text("Харьковская область");
                    opt321 = t("<option>").attr({
                        value: "Херсонская область"
                        }).text("Херсонская область");
                    opt322 = t("<option>").attr({
                        value: "Хмельницкая областьь"
                        }).text("Хмельницкая область");
                    opt323 = t("<option>").attr({
                        value: "Черкасская область"
                        }).text("Черкасская область");
                    opt324 = t("<option>").attr({
                        value: "Черниговская область"
                        }).text("Черниговская область");
                    opt325 = t("<option>").attr({
                        value: "Черновицкая область"
                        }).text("Черновицкая область");
                    reg.append(opt31).append(opt32).append(opt33).append(opt34).append(opt35).append(opt36).append(opt37).append(opt38).append(opt39).append(opt310).append(opt311).append(opt312).append(opt313).append(opt314).append(opt315).append(opt316).append(opt317).append(opt318).append(opt319).append(opt320).append(opt321).append(opt322).append(opt323).append(opt324).append(opt325);
                    lab.append(reg);
                    ow.append(lab);

let city1 = t("<div>").attr({
                    class: "smart-basket__input-wrapper"
                }),
                lw = t("<input>").attr({
                    class: "smart-basket__user-input",
...
let address = t("<div>").attr({
                    class: "smart-basket__input-wrapper"
                }),
                add = t("<input>").attr({
                    class: "smart-basket__user-input",
                    type: "text",
                    placeholder: "Адрес доставки/Номер отделения",
                    name: "address",
          ...
          /* let c = t("<div>").attr({
            ...
            r.append(n).append(ow).append(c), a.agreement.isChecked && r.append(d), k.append(u).append(m), s.append(r).append(k), m.click(function(t) {
                t.preventDefault();
                let s = e.getProducts() || {};
